...
/*
 * @class AdjustableImageOverlay
 * @aka L.AdjustableImageOverlay
...
export const AdjustableImageOverlay = ImageOverlay.extend({
...
// @factory L.adjustableimageOverlay(imageUrl: String, bounds: LatLngBounds, options?: AdjustableImageOverlay options)
// Instantiates an image overlay object given the URL of the image and the
// geographical bounds it is tied to.
export const adjustableimageOverlay = function(imgSrc, topleft, topright, bottomleft, options) {
	return new AdjustableImageOverlay(imgSrc, topleft, topright, bottomleft, options);
};
